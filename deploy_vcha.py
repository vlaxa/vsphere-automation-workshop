...
vcha_dc_name="LAB"    #Datacenter name 
...
active_vcha_vm_name="VCSA" #Active node/VC VM name
active_vc_username="administrator@vsphere.local"  #Active VC username
active_vc_password="VMware1!"  #Active VC password
active_vc_url="https://10.188.140.24"  #Active VC public IP
active_vc_thumbprint="a0:99:df:a9:4a:e7:a2:31:9d:6d:0a:fa:90:8e:33:5e:54:79:35:84" #Active VC thumbprint
passive_vc_datastore="VMFS_SSD"  #Passive node datastore
witness_vc_datastore="VMFS_SSD"  #Witness node datastore
